...
import {getCredentialProvider, getWallet} from '../helpers/wallet-helpers';
import {createVerificationController} from '@docknetwork/wallet-sdk-core/src/verification-controller';
import {verifyPresentation} from '@docknetwork/sdk/utils/vc/presentations';
import axios from 'axios';
import { ANY_CREDENTIAL_TEMPLATE_ID, createProofRequest } from '../helpers/certs-helpers';

const testAPIURL = process.env.TESTING_API_URL || null;
const dockApiToken = process.env.CERTS_API_KEY;
