...
describe('Wallet', () => {
  ...
  it('resolveApiNetwork', () => {
    expect(
      resolveApiNetwork({
        url: 'https://creds-testnet2.dock.io/proof/0bb39274-4ef1-4e7f-ab8d-d91d8926d9af',
  ...
  describe('credentialResolver', () => {
    it('expect to resolve credential to testnet', async () => {
      const result = await credentialResolver({
        document: {
          id: 'https://creds-testnet2.dock.io/d39b15fe997004db702c9faaf98f9fd619cdf40088549648fb288ea679b53e23?_ga=2.46968743.1402343540.1684360698-1482908456.1677577177',
          type: ['VerifiableCredential'],
        },
        dataStore: wallet.dataStore,
      });
