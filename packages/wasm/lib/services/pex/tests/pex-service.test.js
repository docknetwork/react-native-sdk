...
describe('Pex Examples', () => {
  ...
  it('expect to filter credentials based on a date range AND an numerical filter', () => {
    const credentials = [
      {
        '@context': [
          'https://www.w3.org/2018/credentials/v1',
    ...
    const presentationDefinition = {
      id: 'released after 1995 AND less than $50',
      input_descriptors: [
        {
          id: 'Multifield Test',
          name: 'Test - released after 1995 AND less than $50',
          purpose:
            'Filter credentials based on being released after 1995 AND less than $50',
          constraints: {
            fields: [
              {
                path: ['$.credentialSubject.product1.release_date'],
