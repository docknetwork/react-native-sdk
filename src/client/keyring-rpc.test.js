...
describe("KeyringRpc", () => {
  ...
  describe("addFromJson", () => {
    ...
    it("wrong password", async () => {
      ...
      expect(result.toString()).toBe('Error: Unable to decode using the supplied passphrase');
    });
  });
